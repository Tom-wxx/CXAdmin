...
--   4. add_notification_permissions.sql  Notification menus / perms
--   5. add_message_permissions.sql       Message menus / perms
--   6. add_cache_monitor_permissions.sql Cache-monitor menu / perms
--   7. add_job_permissions.sql           Job module button perms
--   8. add_statistics_permissions.sql    Statistics menus / perms
--   9. add_schedule_jobs.sql             Sample scheduled job rows
-- ====================================================================
...
-- 既有数据库请单独执行 database/upgrade/20260713_add_login_pet_config.sql，勿重复执行本初始化脚本。
