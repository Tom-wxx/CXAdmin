...
public class SysJobLogController {
    ...
    @GetMapping("/{jobLogId}")
    public Result<SysJobLog> getInfo(@Parameter(description = "日志ID") @PathVariable Long jobLogId) {
    ...
    public Result<Void> remove(@Parameter(description = "日志ID数组") @PathVariable Long[] jobLogIds) {
