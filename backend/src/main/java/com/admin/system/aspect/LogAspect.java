...
public class LogAspect {
     ...
     * @param joinPoint 切点
     */
    @AfterReturning(pointcut = "logPointCut() && @annotation(controllerLog)", returning = "jsonResult")
     ...
     * @param e         异常
     */
    @AfterThrowing(value = "logPointCut() && @annotation(controllerLog)", throwing = "e")
    ...
    private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog) throws Exception {
        ...
        if (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name().equals(requestMethod)) {
            ...
            operLog.setOperParam(substring(JSON.toJSONString(paramsMap), 0, 2000));
        }
    }
